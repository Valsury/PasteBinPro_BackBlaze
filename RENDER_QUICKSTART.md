...
- ✅ **`nousresearch/nous-hermes-2-mixtral-8x7b-dpo`** 🆓 - мощная для сложных задач

### Как это работает
1. Система автоматически загружает все модели OpenRouter API
2. Фильтрует список, оставляя только бесплатные
3. Показывает их в интерфейсе с пометкой 🆓
4. При попытке выбрать платную модель автоматически выбирает бесплатную альтернативу
...
**Результат:** список из 7+ бесплатных моделей без платных вариантов.